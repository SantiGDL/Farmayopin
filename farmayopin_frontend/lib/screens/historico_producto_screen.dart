...
class _HistoricoProductoScreenState extends State<HistoricoProductoScreen> {
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              final Widget seleccion = Column(
                ...
                children: [
                  const Text(
                    'Vea el detalle de compras del producto seleccionado',
  ...
  Widget _contenido(List<CompraProducto> filtradas) {
    ...
    if (filtradas.isEmpty) {
      return const Center(
        child: Text(
          'No se encontraron compras para esta búsqueda.',
          textAlign: TextAlign.center,
        ),
      );
    }
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                for (final CompraProducto compra in visibles) _fila(compra),
              ],
            ),
          ),
        );
  ...
  Widget _fila(CompraProducto compra) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            flex: 3,
            child: Text(
              formatearImporte(compra.precioUnitario),
